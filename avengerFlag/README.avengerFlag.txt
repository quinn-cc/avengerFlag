BZFlag Server Plugin: avengerFlag
================================================================================
...
avengerFlag directory to a new name, and then manually replace avengerFlag
...
To load the plugin with specific settings, use the format:
  -loadplugin avengerFlag,<powerlevel>,<meaning>,<leet>
For example:
  -loadplugin avengerFlag,1006,42,1337

To load the plugin and specify a configuration file, use the format:
  -loadplugin avengerFlag,<configfilename>
For example:
  -loadplugin avengerFlag,/path/to/my/sampleplugin.cfg
